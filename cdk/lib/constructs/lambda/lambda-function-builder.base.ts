...
export abstract class LambdaFunctionBuilder extends Construct {
    ...
    withKnowledgeBase(knowledgeBaseId: string, environmentVariable?: string): this {
    ...
    withBedrockFoundationalModels(
        ...
        const policyStatementProps = this.createBedrockFoundationModelPolicyStatementProps(bedrockModelIdentifiers);
